...
public class ApplicationTests {
    ...
    public void testRedis() {
        ...
        City cityInfo = cityService.getCityByName("上海");
         ...
         LOGGER.info(String.valueOf(cityInfo));
    ...
    public void testRedisCache() {
        ...
        LOGGER.info("第一次查询：" + String.valueOf(cityInfo));

        // 从 redis 中取数据, 第二次查询
        cityInfo = cityService.getCityByName("北京");
        LOGGER.info("第二次查询：" + String.valueOf(cityInfo));
 
        // 更新 city 的描述信息后查询
        cityService.updateCityDescription("北京", "想不想去北京玩玩呢？");
        cityInfo = cityService.getCityByName("北京");
        LOGGER.info("更新描述后查询：" + String.valueOf(cityInfo));
